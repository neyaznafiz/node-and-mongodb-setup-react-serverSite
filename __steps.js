 ...
 * 2. create cluster
 * 3. create user neyaz and pass
 * 4. Network access --> IP address: current IP and allow all (0.0.0.0.)
 * 5. database > Connect > code copy from CRUD mongo website and paste in index.js
 * ---------------------------------
 * 
 * CRUD Operation
 * ---------------------------------
 ...
 * 2. set a function in onSubmit get form data and create user object
 * 3. on server: Create user POST method to recive data on the backend.
 ...
 * 4. cursor.toArray()
 * 5. return the result
 * 6. from client useEffect and display user like we have done before.
 * ----------------------------------------------------
 * DELETE
 * -----------------
 * 1.
